...
batchname=EXPIRE_ACTIVE_FINANCIAL_INST_CREDIT_ASSESS
dtx=`date +'%y%m%d'`"   "`date +'%H%M%S'`
rrstep=""
bpsw=0
ut=U_01_EXPIRE_ACTIVE_FINANCIAL_INST_CREDIT_ASSESS.txt
st=S_01_EXPIRE_ACTIVE_FINANCIAL_INST_CREDIT_ASSESS.txt
if [ "$1" != "" ] && [ "$1" != "step00" ]
then
