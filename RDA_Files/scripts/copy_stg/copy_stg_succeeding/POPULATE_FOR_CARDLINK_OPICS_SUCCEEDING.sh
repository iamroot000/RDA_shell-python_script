...
function step05
{
 ...
 echo   "S_POPULATE_CREDIT_CARD_ACCOUNT_FOR_CARDLINKSUCCEEDING_LOAD.txt deleted"
 else
 ...
 $swcode $swuser -c "${dirlog} $exesas /sasprog/${lev}/copy_stg/POPULATE_CREDIT_CARD_ACCOUNT_FOR_CARDLINK_SUCCEEDING_LOAD.sas"
 rcode=$?
 rrstep=""
 logrc
 }
