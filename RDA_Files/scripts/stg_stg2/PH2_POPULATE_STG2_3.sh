...
function step12
{
 ...
 if [ -f $st ]
 then
 touch S_PH2_01_SRCDATA_STG2_INDIVIDUAL_CUSTOMER.txt S_PH2_POPULATE_STG2_3.txt
 else
...
batchname=PH2_POPULATE_STG2_3
dtx=`date +'%y%m%d'`"   "`date +'%H%M%S'`
rrstep=""
bpsw=0
ut=U_01_SRCDATA_STG2_INDIVIDUAL_CUSTOMER.txt
st=S_01_SRCDATA_STG2_INDIVIDUAL_CUSTOMER.txt
if [ "$1" != "" ] && [ "$1" != "step00" ]
then
