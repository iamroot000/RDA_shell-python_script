...
function step14
{
 ...
 desc="Call SAS job"
 cd /sasprog/triggers
 if [ -f S_01_POPULATE_STG2_X_GRADE_X_RATE.txt  ]
 then
 rm S_01_POPULATE_STG2_X_GRADE_X_RATE.txt
 echo   "S_01_POPULATE_STG2_X_GRADE_X_RATE.txt deleted "
 else
 echo  "S_01_POPULATE_STG2_X_GRADE_X_RATE.txt does not exist"
 fi
 if [ -f U_01_POPULATE_STG2_X_GRADE_X_RATE.txt ]
 then
 rm U_01_POPULATE_STG2_X_GRADE_X_RATE.txt
 echo  "U_01_POPULATE_STG2_X_GRADE_X_RATE.txt deleted"
 else
 echo   "U_01_POPULATE_STG2_X_GRADE_X_RATE.txt does not exist"
 fi
 $swcode $swuser -c "${dirlog} $exesas /sasprog/${lev}/stg_stg2/01_POPULATE_STG2_X_GRADE_X_RATE.sas"
 rcode=$?
 rrstep=""
 logrc
 }
...
function step15
{
 ...
 desc="Call SAS job"
 cd /sasprog/triggers
 if [ -f S_01_POPULATE_STG2_ASSESSMENT_VALUES.txt  ]
 then
 rm S_01_POPULATE_STG2_ASSESSMENT_VALUES.txt
 echo   "S_01_POPULATE_STG2_ASSESSMENT_VALUES.txt deleted "
 else
 echo  "S_01_POPULATE_STG2_ASSESSMENT_VALUES.txt does not exist"
 fi
 if [ -f U_01_POPULATE_STG2_ASSESSMENT_VALUES.txt ]
 then
 rm U_01_POPULATE_STG2_ASSESSMENT_VALUES.txt
 echo  "U_01_POPULATE_STG2_ASSESSMENT_VALUES.txt deleted"
 else
 echo   "U_01_POPULATE_STG2_ASSESSMENT_VALUES.txt does not exist"
 fi
 $swcode $swuser -c "${dirlog} $exesas /sasprog/${lev}/stg_stg2/01_POPULATE_STG2_ASSESSMENT_VALUES.sas"
 rcode=$?
 rrstep=""
 logrc
 }
